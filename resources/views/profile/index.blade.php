            ...
            @if(count($profiles)==0)
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <img src="/storage/photos/{{$profiles[0]->photo}}" style="width: 150px; height: 160px; float: left; border-radius: 50%; margin-right: 25px;" alt="No image founded">
                            ...
                            <a href="/profile/{{$profiles[0]->registration_no}}/edit" class="btn btn-primary btn-sm">Update</a>
                ...
                <div style="background: #2C2C28 ;">
                    ...
                    <div class="card-body" style="color: white;">
                        <table class="table table-striped" style="color: white;">
                                ...
                                <tr>
                                    <td> <h5> I'm a </h5> </td>
                                    <td> <h5> {{$profiles[0] -> designation}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> Registration No </h5> </td>
                                    <td> <h5> {{$profiles[0] -> registration_no}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> Session </h5> </td>
                                    <td> <h5> {{$profiles[0] -> batch_id}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> Contact No </h5> </td>
                                    <td> <h5> {{$profiles[0] -> contact_number}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> Date OF Birth </h5> </td>
                                    <td> <h5> {{$profiles[0] -> date_of_birth}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> Department </h5> </td>
                                    <td> <h5> {{$profiles[0] -> department}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> Blood Group </h5> </td>
                                    <td> <h5> {{$profiles[0] -> blood_group}} </h5> </td>
                                </tr>
                                <tr>
                                    <td> <h5> CGPA </h5> </td>
