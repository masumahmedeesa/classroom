            ...
            <div class="col-md-10">
                <div style="background: #2C2C28 ;">
                    ...
                    <div class="card-body">
                        ...
                        {{ Form::open(['action' => ['CoursesController@update',$course->cid], 'method' => 'POST','enctype'=>'multipart/form-data']) }}
                        <div class="form-group">
                            <h5 style="color: #6cbb23;"> {{Form::label('sessionYear','Academic Year | Session Year')}}</h5>
                            {{Form::text('sessionYear',$course->sessionYear,['class' => 'form-control', 'placeholder' => 'Academic Year | Session Year'])}}
                        ...
                        <div class="form-group">
                            ...
                            {{Form::text('teacherName',$course->teacherName,['class' => 'form-control', 'placeholder' => 'Teacher Name'])}}
                        </div>
                        <div class="form-group">
                            <h5 style="color: #6cbb23;"> {{Form::label('credit','Credit')}} </h5>
                            {{Form::text('credit',$course->credit,['class' => 'form-control', 'placeholder' => 'Credit'])}}
                        </div>
                        <div class="form-group">
                            <h5 style="color: #6cbb23;"> {{Form::label('timeSpan','Schedule | Full Details ')}} </h5>
                            {{Form::textarea('timeSpan',$course->timeSpan,['id' => 'article-ckeditor','class' => 'form-control', 'placeholder' => 'Schedule | Full Details'])}}
                        </div>
