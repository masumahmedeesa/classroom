...
<body class="demo-1">
	<main>
		...
		<div class="content">
			...
			<h2 class="content__title"> <a href="#"> Classroom </a> </h2>
			<!-- <h1 class="content__subtitle">
					<a href="/first"> A Virtual Classroom </a>
				</h1> -->
			<h1 class="content__subtitle" style="color: black;">
			<a class="btn btn-primary btn-lg" href="{{ route('login') }}" role="button" style="tab-size: 30;"> LOGIN </a> 
